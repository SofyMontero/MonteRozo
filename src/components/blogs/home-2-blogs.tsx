      ...
      <div className="container">
        <div className="position-relative">
          <div className="title-one mb-20 lg-mb-10">
            <h2>Recursos para tu bienestar</h2>
          </div>
          <p className="text-lg mb-40 lg-mb-10">
            Artículos sobre salud mental, escritos con rigor y un lenguaje
            accesible.
          </p>
          ...
          <div className="section-btn sm-mt-40">
            <NavLink to="/blog-factoring/1" className="btn-five icon-link">
              <span className="text">Leer más artículos</span>
